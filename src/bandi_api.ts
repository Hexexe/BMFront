...
export async function getBandsByCountryAndGenre(country: string, genre: string) {
    try {
        const response = await axios.get(`${API_URL}/bands/country/${country}/genre/${genre}`);
        return response.data;
    } catch (error) {
        return await Promise.reject(error.message);
    }
}
export async function getBandsByCountryAndStatus(country: string, status: string) {
    try {
        const response = await axios.get(`${API_URL}/bands/country/${country}/status/${status}`);
        return response.data;
    } catch (error) {
        return await Promise.reject(error.message);
    }
...
export async function getBandsByCountryAndName(country: string, name: string) {
    try {
        const response = await axios.get(`${API_URL}/bands/country/${country}/${name}`);
        return response.data;
    } catch (error) {
        return await Promise.reject(error.message);
    }
...
export async function getBandsByNameAndStatus(name: string, status: string) {
    try {
        const response = await axios.get(`${API_URL}/bands/${name}/status/${status}`);
        return response.data;
    } catch (error) {
        return await Promise.reject(error.message);
    }
...
export async function getBandsByGenreAndStatus(genre: string, status: string) {
    try {
        const response = await axios.get(`${API_URL}/bands/genre/${genre}/status/${status}`);
        return response.data;
    } catch (error) {
        return await Promise.reject(error.message);
    }
